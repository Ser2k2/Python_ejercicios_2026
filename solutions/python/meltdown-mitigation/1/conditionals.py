...
def is_criticality_balanced(temperature, neutrons_emitted):
    ...
    if temperature < critical_temperature and neutrons_emitted > critical_neutrons and (temperature * neutrons_emitted) < critical_product:
        return True
    else:
        return False
...
def reactor_efficiency(voltage, current, theoretical_max_power):
    ...
    efficiency_percentage = (actual_power / theoretical_max_power) * 100
